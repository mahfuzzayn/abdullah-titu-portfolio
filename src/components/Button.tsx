...
const Button = ({
    ...
    const variantClasses = {
        primary: `bg-primary text-foreground hover:bg-primary-hover hover:text-primary-foreground`,
        ...
        dark: `bg-foreground text-background hover:bg-foreground/80 hover:text-foreground`,
            ...
            return (
                ...
                >
                    {variant !== "link" && (
                        <span
                            className={cn(
                                `absolute top-[200%] left-0 right-0 h-full rounded-[50%] group-hover:top-0 transition-all duration-500 scale-150`,
                                defaultBg && defaultBg
                            )}
                        ></span>
                    )}
