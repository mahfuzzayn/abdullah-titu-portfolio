    ...
    return (
        <>
            ...
            >
                <div
                    className={cn(
                        'fixed inset-0 scale-150 translate-x-1/2 rounded-[50%] bg-secondary duration-700 delay-150 z-[-1]',
                        {
                            'translate-x-0': isMenuOpen,
                        },
                    )}
                ...
                <div className="w-full max-w-[300px] mx-8 sm:mx-auto">
                    ...
                    <div className="flex flex-col gap-2">
                        <Link href={`mailto:${generalInfoData.email}`}>
                            {generalInfoData.email}
                        </Link>
                        <Link href={`https://wa.me/+8801862100733`}>
